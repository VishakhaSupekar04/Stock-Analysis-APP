...
namespace Midterm
{
    ...
    public partial class TimeDaily
    {
    ...
    {
        //for converting dictionary data into list
        public static List<TimeSeriesDaily> dailyStockList;
        public static List<string> stockDate;
        public static Boolean flag;
    }

    public partial class TimeDaily
    {
        public static TimeDaily FromJson(string json) => JsonConvert.DeserializeObject<TimeDaily>(json, Midterm.Converter.Settings);
    }
